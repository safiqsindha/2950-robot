...
/**
 * Planner-agnostic interface for a time-parameterised holonomic trajectory. Adapted from Team 4481
 * Rembrandts' {@code HolonomicTrajectory}.
 *
 * <p>Decouples trajectory <em>followers</em> from trajectory <em>sources</em>. A {@link
 * ChoreoTrajectoryAdapter} wraps a Choreo {@code Trajectory<SwerveSample>} today; a future adapter
 * could wrap PathPlanner, a runtime HUB-aligner, or a hand-rolled trapezoid — the follower doesn't
 * have to change.
 *
