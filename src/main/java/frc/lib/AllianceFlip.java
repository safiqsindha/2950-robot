...
/**
 * Utility for flipping coordinates between red and blue alliance origins. The 2026 REBUILT WELDED
 * field is 16.541 m long (X axis) and 8.069 m wide (Y axis). Blue alliance origin is at the left
 * corner of the blue driver station wall.
 */
